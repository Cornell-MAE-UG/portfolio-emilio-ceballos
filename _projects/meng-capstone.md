...
---
<figure class="inline-image-caption-right">
  <img src="{{ '/assets/images/poster-presentation.jpg' | relative_url }}" alt="Zeke and I at poster presentation" class="inline-image" style="width: 200px" />
  <figcaption>Showing our research at the Cornell MSE Gala</figcaption>
</figure>
...
This project was my first introduction to hands-on CFD. I was heavily involved in every step of the simulation process, including: determining appropriate Boundary Conditions, setting up the mesh and DPM, simulation troubleshooting, data processing, and reporting the results. To learn more about our research and our findings, you can find our research paper [Computational Fluid Dynamics Analysis of Inlet Jet Angle and Geometry Effects on Particle Removal in a Mixed-Cell Raceway]({{ "/assets/CFD_Capstone_Project.pdf" | relative_url }}).
